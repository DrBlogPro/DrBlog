...
body, h1, h2, h3, h4, h5, h6, label, button, input, select, textarea, li,
	a, strong, i, span, th, td {
...
@media ( min-width : 25em) {
	...
	.grid-u-sm-1-4, .grid-u-sm-3-12 {
		width: 25%;
	}
	.grid-u-sm-1-3, .grid-u-sm-4-12 {
		width: 33.3333%;
	}
	.grid-u-sm-2-5 {
		width: 40%;
	}
	.grid-u-sm-1-2, .grid-u-sm-6-12 {
		width: 50%;
	}
	.grid-u-sm-3-5 {
		width: 60%;
	}
	.grid-u-sm-2-3, .grid-u-sm-4-6, .grid-u-sm-8-12 {
		width: 66.6667%;
	}
	.grid-u-sm-3-4, .grid-u-sm-9-12 {
		width: 75%;
	}
	.grid-u-sm-1 {
		width: 100%;
...
@media ( min-width : 34.375em) {
	...
	.grid-u-md-1-4, .grid-u-md-3-12 {
		width: 25%;
	}
	.grid-u-md-1-3, .grid-u-md-4-12 {
		width: 33.3333%;
	}
	.grid-u-md-2-5 {
		width: 40%;
	}
	.grid-u-md-1-2, .grid-u-md-6-12 {
		width: 50%;
	}
	.grid-u-md-3-5 {
		width: 60%;
	}
	.grid-u-md-2-3, .grid-u-md-4-6, .grid-u-md-8-12 {
		width: 66.6667%;
	}
	.grid-u-md-3-4, .grid-u-md-9-12 {
		width: 75%;
	}
	.grid-u-md-1 {
		width: 100%;
...
@media ( min-width : 46.875em) {
	...
	.grid-u-lg-1-4, .grid-u-lg-3-12 {
		width: 25%;
	}
	.grid-u-lg-1-3, .grid-u-lg-4-12 {
		width: 33.3333%;
	}
	.grid-u-lg-2-5 {
		width: 40%;
	}
	.grid-u-lg-1-2, .grid-u-lg-6-12 {
		width: 50%;
	}
	.grid-u-lg-3-5 {
		width: 60%;
	}
	.grid-u-lg-2-3, .grid-u-lg-4-6, .grid-u-lg-8-12 {
		width: 66.6667%;
	}
	.grid-u-lg-3-4, .grid-u-lg-9-12 {
		width: 75%;
	}
	.grid-u-lg-1 {
		width: 100%;
...
@media ( min-width : 62.5em) {
	...
	.grid-u-xl-1-4, .grid-u-xl-3-12 {
		width: 25%;
	}
	.grid-u-xl-1-3, .grid-u-xl-4-12 {
		width: 33.3333%;
	}
	.grid-u-xl-2-5 {
		width: 40%;
	}
	.grid-u-xl-1-2, .grid-u-xl-6-12 {
		width: 50%;
	}
	.grid-u-xl-3-5 {
		width: 60%;
	}
	.grid-u-xl-2-3, .grid-u-xl-4-6, .grid-u-xl-8-12 {
		width: 66.6667%;
	}
	.grid-u-xl-3-4, .grid-u-xl-9-12 {
		width: 75%;
	}
	.grid-u-xl-1 {
		width: 100%;
...
@font-face {
	...
	src:
		url("https://dl.dropboxusercontent.com/u/26351585/Comeon/comeon-iconfamily.woff2")
		format("woff2");
	src:
		url("https://dl.dropboxusercontent.com/u/26351585/Comeon/comeon-iconfamily.woff")
		format("woff");
	font-weight: normal;
	font-style: normal;
}
...
.ui-field--hidden, .ui-button--hidden {
	height: 0;
	margin: 0;
}
...
<body>
	<div class="wrap flex-c-c">
		<form action="" method="" class="flex-c-c">
			...
			<input type="email" placeholder="email" class="ui-field" id="js-field__email" /> 
			<input type="password" placeholder="password" class="ui-field" id="js-field__pass" /> 
			<input type="password" placeholder="repeat password" class="ui-field" id="js-field__r-pass" />
